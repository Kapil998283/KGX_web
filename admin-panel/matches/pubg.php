                ...
                try {
                    ...
                    foreach ($participants as $user_id) {
                        ...
                        $notification_message = sprintf(
                            "Your PUBG match scheduled for %s has been cancelled. Entry fee of %d %s has been refunded to your account.",
        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="pubg.php">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="container-fluid py-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="h3 mb-0">PUBG Match Management</h2>
        ...
        <div class="modal-content">
            ...
            <form id="matchForm" method="POST" class="needs-validation" novalidate>
                <div class="modal-body">
                    ...
                    <input type="hidden" name="game_id" value="2"> <!-- PUBG game ID -->
