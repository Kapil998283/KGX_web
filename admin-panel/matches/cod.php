...
$stmt = $db->query("SELECT m.*, g.name as game_name, g.image_url as game_image,
                    ...
                    WHERE g.name = 'Call of Duty Mobile'
        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="cod.php">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="container-fluid py-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="h3 mb-0">Call of Duty Mobile Match Management</h2>
        ...
        <div class="modal-content">
            ...
            <form id="matchForm" method="POST" class="needs-validation" novalidate>
                <div class="modal-body">
                    ...
                    <input type="hidden" name="game_id" value="4"> <!-- COD Mobile game ID -->
